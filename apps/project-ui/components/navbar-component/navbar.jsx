...
import CreateCompany from "../create-advertisement/createAdvertisement.jsx";
import TestUpload from "../create-advertisement/testUpload.jsx";
import UserProfilePage from "../user-profile-component/userProfile.jsx";
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    `${import.meta.env.VITE_BASE_URL}/users/my-profile`,
                    {
                        headers: {
                ...
                const userRole = response.data.userRoles[0].roles.roleName;
            ...
            >
                ...
                >
                    <Link onClick={scrollToTop} to="/">
                        <img src="/D.png" className="w-24 max-lg:w-24 border" alt="D" />
                    </Link>
                    <ul
                        className={
                            showCase1Page
                    ...
                    >
                        ...
                        {isLogin && userRole === 'CONSULTANT' && (
                            <Button
                                onClick={() => {
                                    openModal(<CreateCompany />);
                                }}
                        ...
                        {isLogin && <UserOutlined onClick={() => {
                            openModal(<UserProfilePage/>)
                        }} />}
                    </ul>
                    <ul
                        className={`${
